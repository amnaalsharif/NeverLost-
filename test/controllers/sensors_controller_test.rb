...
class SensorsControllerTest < ActionController::TestCase
  ...
  test "should create sensor" do
    assert_difference('Sensor.count') do
      post :create, sensor: { coordinate: @sensor.coordinate, date: @sensor.date, sensor_id: @sensor.sensor_id }
    end
  ...
  test "should update sensor" do
    patch :update, id: @sensor, sensor: { coordinate: @sensor.coordinate, date: @sensor.date, sensor_id: @sensor.sensor_id }
    assert_redirected_to sensor_path(assigns(:sensor))
  end
